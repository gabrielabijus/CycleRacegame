...
function preload() {
  ...
  img1CiclistaPrincipal = loadAnimation(
  ...
  opVermelhoimg1 = loadAnimation(
    "images/opponent7.png",
...
function setup() {
  ...
  ciclistaPrincipal.setCollider("rectangle", 0, 0, 100, 100);
...
function draw() {
  ...
  if (estadoJogo === JOGAR) {
    ...
    text("Aperte r para reiniciar", 550, 200);
  ...
  if (keyDown("r") && estadoJogo === ENCERRAMENTO) {
    recomecar()
